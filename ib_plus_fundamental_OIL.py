...
# 2. STRATEGY SETTINGS
SYMBOLS = ["XAUUSD"] #SO 2010-2018 GOLD not bad, 2020+ good for oil
TIMEFRAMES = ["4h"]
RISK_REWARD = 2.0
...
class MacroProcessor:
    ...
    def fetch_and_process(self):
        ...
        df_macro.loc[(df_macro["Imports"] < 0) & (df_macro["Exports"] >0), "USD_Score"] += 1
        df_macro.loc[(df_macro["Imports"] > 0) & (df_macro["Exports"] <0), "USD_Score"] -= 1
        ...
        #rule 6:
        df_macro.loc[df_macro['CPI'] > 5, 'USD_Score'] += 1
